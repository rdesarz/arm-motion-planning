...
int main() {
  ...
  const auto missing = amp::AligatorReachPlanner::load(
  ...
  passed &= require_error(planner->plan(invalid_duration), amp::PlanningErrorCode::invalid_request,
  ...
  passed &= require_error(planner->plan(nonfinite_target), amp::PlanningErrorCode::invalid_request,
  ...
  passed &= require_error(planner->plan(nonfinite_start), amp::PlanningErrorCode::invalid_request,
